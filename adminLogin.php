    ...
    <div class="d-flex justify-content-center h-100">
      <div class="card">
        <div class="card-header">
          <h3><b>Admin </b>Sign in</h3>
          
          <div class="d-flex justify-content-end LoginType">
            <button type="button" class="btn btn-warning btn-sm" onclick="openWinAccount()">User</button>
        ...
        <div class="card-body">
          ...
          <?php
					...
					if(isset($_SESSION['AdminUserName'])){
						echo "Hi Admin User<br>".$_SESSION['AdminUserName'].", You are Logged in. Directing you to the next page."; 
