    ...
    <div class="ticketMain">
        ...
        <form action="functions.php" method="post">
            ...
            <div class="form-group">
                ...
                <br>
                <input name="ticketTopic"  type="text" placeholder="Enter a Topic">
            </div>
            <!--Main text area -->
            <div class="form-group">
                <label><strong>Content</strong></label>
                <textarea name="ticketContent" class="form-control" placeholder="Enter 150 Char" rows="3"></textarea>
            </div>
			
			<input type="submit" name="ticketSubmit" value="Submit Ticket"></input>
        </form>
